...
//              style.innerHTML = '.mp_loading{position:absolute;width:100%;height:100%;overflow:hidden;background-color:#415f9d;left:0;top:0;-webkit-transform-style:preserve-3d;z-index:1}.loading{background-image:url("../static/img/loading.gif");background-size:19.375rem 5rem;width:19.375rem;height:5rem}.mp_loading_clip{position:absolute;top:50%;left:50%;margin-left:-9.9375rem;margin-top:-2.5rem;overflow:hidden}.mp_loading_txt{width:100px;height:30px;line-height:30px;position:absolute;left:50%;top:50%;text-align:center;color:#fff;margin-left:-50px;margin-top:30px}';
            ...
            if (!_loadDom) {
                ...
                _loadDom.innerHTML = '<div class="mp_loading_clip loading"><div class="mp_loading_bar" style="border-color:"' + color + '></div></div>';
