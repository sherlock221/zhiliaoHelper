(function () {
    ...
    var util = (function () {
        ...
        BIUtil.prototype.getPVID = function () {
            //从Cookie获取pvid
            var pvid = this.getCookie('BI_PVID');
            //如没有则创建pvid
            if(!pvid){
                pvid = this.createGuid();
                this.setCookie('BI_PVID', pvid);
            }
            //返回pvid
            return pvid;
        };
    ...
    var bi = (function (util) {
        ...
        BI._getBasicData = function () {
            ...
            this.push(1, 'pvid', util.getPVID());					//PV统计ID
            ...
            this.push(1, 'lt', util.getLoadTime());					//加载时间
