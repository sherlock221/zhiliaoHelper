        ...
        window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (a) {
            ...
            a.fn.serializeArray = function () {
                ...
                return a([].slice.call(this.get(0).elements)).each(function () {
                    b = a(this), c = b.attr("type"), "fieldset" != this.nodeName.toLowerCase() && !this.disabled && "submit" != c && "reset" != c && "button" != c && ("radio" != c && "checkbox" != c || this.checked) && d.push({name: b.attr("name"), value: b.val()})
                }), d
            ...
            var d = a.zepto, e = d.qsa, f = d.matches, g = a.expr[":"] = {visible: function () {
